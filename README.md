...
Vogliamo che Shadowbound sia un progetto veramente community-driven! Ci sono molti modi per contribuire:

### Contributi Tecnici
- Correzione del regolamento
- Creazione di nuove classi, razze, incantesimi
- Sviluppo di nuove meccaniche
- Traduzione e localizzazione

### Contributi Creativi
- Scrittura di avventure e campagne
- Creazione di ambientazioni
- Illustrazioni e grafica
- Mappe e risorse visive

### Contributi Organizzativi
- Gestione della community
- Moderazione discussioni
- Organizzazione eventi di playtest
...
Tutti i partecipanti alla community devono aderire al nostro [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md).
